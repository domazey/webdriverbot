...
public class WDBFieldDecorator implements FieldDecorator {
    ...
    public WDBFieldDecorator(ElementLocatorFactory factory,
    ...
    protected InvocationHandler getHandler(ElementLocator locator, Field elemField) {
        ...
        try {
            handler = handlerClass.getConstructor(ElementLocator.class, Field.class, ConfigContext.class, WebDriver.class)
    ...
    protected InvocationHandler getListHandler(ElementLocator locator, Field elemField) {
        InvocationHandler handler = null;
        try {
            handler = handlerListClass.getConstructor(ElementLocator.class, Field.class, ConfigContext.class, WebDriver.class)
                    .newInstance(locator, elemField, botContext, webDriver);
        } catch (IllegalAccessException | IllegalArgumentException | InstantiationException | NoSuchMethodException | SecurityException | InvocationTargetException ex) {
            // shallow
        }
